...
export default function LanguageButton(){
  ...
  return (
    <div style={{position:"relative", display:"inline-block"}}>
      ...
      {open && (
        <ul style={{position:"absolute", zIndex:50, marginTop:8, listStyle:"none",
                    padding:6, border:"1px solid #eee", borderRadius:12, background:"#fff", maxHeight:220, overflow:"auto"}}>
          {options.map(o=>(
            <li key={o.code}>
              <button onClick={()=>{setLang(o.code); setOpen(false);}}
