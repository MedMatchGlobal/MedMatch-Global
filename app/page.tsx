      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        {mode === 'medicine' ? (
          ...
          <>
            ...
            <textarea
              placeholder="Additional details (e.g. symptoms, context)"
            ...
            <textarea
              placeholder="Known allergies or pathologies"
              value={userNotes}
        ...
        <div style={{ fontSize: '0.8rem', color: '#555', marginTop: '2rem' }}>
          ...
          <p style={{ textAlign: 'justify' }}>
            All responses generated by this platform are <strong>language-based informational outputs</strong> derived from public databases and large language models. These are <strong>not reviewed by medical professionals</strong>. Do not rely on this for any medical decisions.
          </p>
