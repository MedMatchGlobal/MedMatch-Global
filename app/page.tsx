...
function Home() {
  ...
  const AGENCIES: Record<string, { name: string; url: string }> = {
    ...
    'United Kingdom': { name: 'MHRA (UK Medicines Regulator)', url: 'https://www.gov.uk/government/organisations/medicines-and-healthcare-products-regulatory-agency', },
    ...
    Israel: { name: 'Ministry of Health – Pharmaceutical Administration', url: 'https://www.health.gov.il/English/Units/MedicalTechnologies/Pharmaceutical/Pages/default.aspx', },
    Ukraine: { name: 'State Service of Ukraine on Medicines and Drugs Control (SMDC)', url: 'https://www.dls.gov.ua/', },
    Russia: { name: 'Roszdravnadzor (Federal Service for Surveillance in Healthcare)', url: 'https://roszdravnadzor.gov.ru/en', },
    Colombia: { name: 'INVIMA (National Institute for Food and Drug Surveillance)', url: 'https://www.invima.gov.co/', },
    Ecuador: { name: 'ARCSA (Agencia Nacional de Regulación, Control y Vigilancia Sanitaria)', url: 'https://www.controlsanitario.gob.ec/', },
    Iceland: { name: 'IMA (Icelandic Medicines Agency)', url: 'https://www.ima.is/', },
    Greenland: { name: 'Danish Medicines Agency (covers Greenland)', url: 'https://laegemiddelstyrelsen.dk/en/', },
    'South Africa': { name: 'SAHPRA (South African Health Products Regulatory Authority)', url: 'https://www.sahpra.org.za/', },
    Mongolia: { name: 'MMRA (Medicines and Medical Devices Regulatory Authority of Mongolia)', url: 'https://mmra.gov.mn/', },
    Pakistan: { name: 'DRAP (Drug Regulatory Authority of Pakistan)', url: 'https://www.drap.gov.pk/', },
    Afghanistan: { name: 'AFDA (Afghanistan Food and Drug Authority)', url: 'https://www.afda.gov.af/', },
   'United Arab Emirates': { name: 'MOHAP (Ministry of Health and Prevention) – Drug Control', url: 'https://www.mohap.gov.ae/', },
    Qatar: { name: 'Ministry of Public Health – Pharmacy & Drug Control Department', url: 'https://www.moph.gov.qa/english/departments/policyaffairs/pdc/Pages/default.aspx', },
    Iran: { name: 'IFDA (Iran Food & Drug Administration)', url: 'https://www.fda.gov.ir/', },
    Iraq: { name: 'Ministry of Health – Iraqi Pharmacovigilance Center (IPhvC)', url: 'https://moh.gov.iq/', },
    Egypt: { name: 'EDA (Egyptian Drug Authority)', url: 'https://edaegypt.gov.eg/', },
    Libya: { name: 'National Center for Food and Drug Control (NCFDC)', url: 'http://ncfmc.ly/', },
    Algeria: { name: 'ANPP (Agence Nationale des Produits Pharmaceutiques)', url: 'https://www.anpp.dz/', },
    Tunisia: { name: 'DPM (Direction de la Pharmacie et du Médicament)', url: 'http://www.santetunisie.rns.tn/fr/directions/dpm', },
    Morocco: { name: 'DMP (Direction du Médicament et de la Pharmacie)', url: 'https://www.sante.gov.ma/', },
    'San Marino': { name: 'AMS (Authority of Medicines and Health Products of the Republic of San Marino)', url: 'https://www.salute.sm/', },
    Monaco: { name: 'Direction de l’Action Sanitaire (Pharmaceuticals)', url: 'https://en.gouv.mc/Health/Health-Requests/Pharmaceuticals', },
    Andorra: { name: 'Ministry of Health (Medicines & Health Products)', url: 'https://www.govern.ad/salut', },
    Luxembourg: { name: 'DPM (Division de la Pharmacie et des Médicaments) – Ministry of Health', url: 'https://sante.public.lu/fr.html', },
    Belgium: { name: 'FAMHP / AFMPS / FAGG (Federal Agency for Medicines and Health Products)', url: 'https://www.famhp.be/en', },
    Liechtenstein: { name: 'Amt für Gesundheit (Office of Public Health) – cooperates with Swissmedic', url: 'https://www.llv.li/inhalt/118/amt-fuer-gesundheit', },
    'Czech Republic': { name: 'SÚKL (State Institute for Drug Control)', url: 'https://www.sukl.eu/', },
    Slovakia: { name: 'ŠÚKL (State Institute for Drug Control)', url: 'https://www.sukl.sk/', },
    Austria: { name: 'BASG (Austrian Federal Office for Safety in Health Care)', url: 'https://www.basg.gv.at/', },
    Poland: { name: 'URPL (Office for Registration of Medicinal Products, Medical Devices and Biocidal Products)', url: 'https://www.urpl.gov.pl/', },
    Hungary: { name: 'OGYÉI (National Institute of Pharmacy and Nutrition)', url: 'https://ogyei.gov.hu/', },
    Romania: { name: 'ANMDMR (National Agency for Medicines and Medical Devices of Romania)', url: 'https://www.anm.ro/', },
    Bulgaria: { name: 'BDA (Bulgarian Drug Agency)', url: 'https://www.bda.bg/en/', },
    Greece: { name: 'EOF (National Organization for Medicines)', url: 'https://www.eof.gr/', },
    Turkey: { name: 'TİTCK (Turkish Medicines and Medical Devices Agency)', url: 'https://www.titck.gov.tr/', },
    Canada: { name: 'Health Canada (Health Products and Food Branch)', url: 'https://www.canada.ca/en/health-canada.html' },
    China: { name: 'NMPA (National Medical Products Administration)', url: 'https://www.nmpa.gov.cn/' },
    India: { name: 'CDSCO (Central Drugs Standard Control Organisation)', url: 'https://cdsco.gov.in/' },
    Japan: { name: 'PMDA (Pharmaceuticals and Medical Devices Agency)', url: 'https://www.pmda.go.jp/' },
   'South Korea': { name: 'MFDS (Ministry of Food and Drug Safety)', url: 'http://www.mfds.go.kr/' },
    Brazil: { name: 'ANVISA (Brazilian Health Regulatory Agency)', url: 'https://www.gov.br/anvisa' },
    Singapore: { name: 'HSA (Health Sciences Authority)', url: 'https://www.hsa.gov.sg/' },
    Thailand: { name: 'Thai FDA (Food and Drug Administration)', url: 'http://www.fda.moph.go.th/' },
    'New Zealand': { name: 'Medsafe (Medicines and Medical Devices Safety Authority)', url: 'https://www.medsafe.govt.nz/' },
    Malaysia: { name: 'NPRA (National Pharmaceutical Regulatory Agency)', url: 'https://www.npra.gov.my/' },
    'Sri Lanka': { name: 'NMRA (National Medicines Regulatory Authority)', url: 'https://www.nmra.gov.lk/' },
    Argentina: { name: 'ANMAT (National Administration of Drugs, Foods and Medical Devices)', url: 'https://www.argentina.gob.ar/anmat' },
    Cyprus: { name: 'Pharmaceutical Services, Ministry of Health', url: 'https://www.moh.gov.cy/moh/phs/phs.nsf/index_en/index_en', },
    Malta: { name: 'Malta Medicines Authority (MMA)', url: 'https://medicinesauthority.gov.mt/', },
    Slovenia: { name: 'JAZMP (Agency for Medicinal Products and Medical Devices of Slovenia)', url: 'https://www.jazmp.si/', },
    Croatia: { name: 'HALMED (Agency for Medicinal Products and Medical Devices of Croatia)', url: 'https://www.halmed.hr/', },
    Serbia: { name: 'ALIMS (Medicines and Medical Devices Agency of Serbia)', url: 'https://www.alims.gov.rs/eng/', },
    'Bosnia and Herzegovina': { name: 'ALMBiH (Agency for Medicinal Products and Medical Devices of Bosnia and Herzegovina)', url: 'https://www.almbih.gov.ba/', },
    'North Macedonia': { name: 'MALMED (Agency for Medicines and Medical Devices)', url: 'https://www.malmed.gov.mk/', },
    Montenegro: { name: 'CALIMS (Agency for Medicines and Medical Devices of Montenegro)', url: 'https://www.calims.me/en/', },
    Albania: { name: 'AKBPM (National Agency of Medicines and Medical Devices)', url: 'https://akbpm.gov.al/', },
    Moldova: { name: 'AMDM (Medicines and Medical Devices Agency of the Republic of Moldova)', url: 'https://amdm.gov.md/', },
    Belarus: { name: 'Center for Examinations and Tests in Health Service (RCETH)', url: 'https://rceth.by/', },
    Norway: { name: 'NoMA (Norwegian Medicines Agency)', url: 'https://www.legemiddelverket.no/', },
    Denmark: { name: 'Danish Medicines Agency', url: 'https://laegemiddelstyrelsen.dk/en/', },
    Sweden: { name: 'Medical Products Agency (Läkemedelsverket)', url: 'https://www.lakemedelsverket.se/english', },
    Finland: { name: 'Fimea (Finnish Medicines Agency)', url: 'https://www.fimea.fi/',},
    'Faroe Islands': { name: 'Danish Medicines Agency (covers Faroe Islands)', url: 'https://laegemiddelstyrelsen.dk/en/', },
    'Vatican City': { name: 'Covered via AIFA (Italian Medicines Agency); Vatican Pharmacy', url: 'https://www.aifa.gov.it/', },
    Jordan: { name: 'JFDA (Jordan Food and Drug Administration)', url: 'https://www.jfda.jo/', },
    Lebanon: { name: 'Ministry of Public Health – Pharmaceutical Products', url: 'https://www.moph.gov.lb/en/', },
    Bahrain: { name: 'NHRA (National Health Regulatory Authority)', url: 'https://www.nhra.bh/', },
    Oman: { name: 'DGPA&DC (Directorate General of Pharmaceutical Affairs & Drug Control)', url: 'https://www.moh.gov.om/en/web/dgpadc', },
    Kuwait: { name: 'Drug & Food Control, Ministry of Health', url: 'https://www.moh.gov.kw/', },
    'Saudi Arabia': { name: 'SFDA (Saudi Food & Drug Authority)', url: 'https://www.sfda.gov.sa/', },
    Taiwan: { name: 'TFDA (Taiwan Food and Drug Administration)', url: 'https://www.fda.gov.tw/ENG/', },
    'Hong Kong': { name: 'Drug Office, Department of Health', url: 'https://www.drugoffice.gov.hk/eng/',},
    Philippines: { name: 'FDA Philippines', url: 'https://www.fda.gov.ph/', },
    Indonesia: { name: 'BPOM (National Agency of Drug and Food Control)', url: 'https://www.pom.go.id/', },
    Vietnam: { name: 'DAV (Drug Administration of Vietnam)', url: 'https://dav.gov.vn/', },
    Chile: { name: 'ISP (Public Health Institute of Chile) – National Agency for Medicines', url: 'https://www.ispch.cl/', },
    Peru: { name: 'DIGEMID (General Directorate of Medicines, Supplies and Drugs)', url: 'https://www.digemid.minsa.gob.pe/', },
    Uruguay: { name: 'MSP – Department of Drugs (Unidad de Medicamentos)', url: 'https://www.gub.uy/ministerio-salud-publica/', },
    Paraguay: { name: 'DINAVISA (National Directorate of Sanitary Surveillance)', url: 'https://www.mspbs.gov.py/dinavisa/',}
};
